...
const About = () => {
  ...
  return (
    <Box sx={{ flexGrow: 1, height: '90vh', display: 'flex', flexDirection: 'column', justifyContent:'center', alignContent:'center'}}>
      <Typography component="h3" variant="h3" align="center" gutterBottom>
        How it works
      </Typography>
      <Grid container  columns={{ xs: 14, sm: 14, md: 14 }}  spacing={2} sx={{display: 'flex',  justifyContent: 'center' }}>
